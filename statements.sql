...
UPDATE usuarios SET id_rol = 3 WHERE id_usuario = 14;
...
UPDATE usuarios SET id_categoria = 2 WHERE id_usuario IN (2, 10, 12);
UPDATE usuarios SET id_categoria = 3 WHERE id_usuario IN (8, 16);
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (6, 19);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (7, 20);
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (6, 18);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (11, 17);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (14);
UPDATE usuarios SET id_categoria = 9 WHERE id_usuario IN (3, 15);
UPDATE usuarios SET id_categoria = 10 WHERE id_usuario IN (4, 13);
...
SELECT usuarios.id_usuario, usuarios.nombre, usuarios.apellido, usuarios.email, usuarios.edad, roles.nombre_rol, categorias.nombre_categoria
	FROM usuarios
	JOIN (roles, categorias) ON usuarios.id_rol = roles.id_rol AND usuarios.id_categoria = categorias.id_categoria;
